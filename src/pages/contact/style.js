export const ContactStyle = {
    contactTitle: `text-center 2xl:text-2xl 2xl:pt-32 font-bold
    xl:text-xl xl:pt-16
    lg:text-xl lg:pt-16
    md:text-lg md:pt-16
    sm:text-md sm:pt-16
    text-md pt-16`,
    ctMain : `flex 2xl:flex-row 2xl:justify-center 2xl:pt-10 2xl:gap-9
    ...
    imageTwo : `2xl:w-[450px] 2xl:h-[450px]
    ...
    textarea: `text-white bg-inherit border border-[#D1D1D1] 2xl:h-60 2xl:py-1 2xl:p-1 2xl:pl-3 2xl:rounded-[4px] resize-none
